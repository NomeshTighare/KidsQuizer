...
import kotlinx.android.synthetic.main.activity_questionsstd4marathi.*


class QuestionsStd4Marathi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd4marathi)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd4Marathi> = getQuestionsStd4Marathi()
