...
import kotlinx.android.synthetic.main.activity_questionsstd3gkn.*


class QuestionsStd3Gkn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd3gkn)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd3Gkn> = getQuestionsStd3Gkn()
