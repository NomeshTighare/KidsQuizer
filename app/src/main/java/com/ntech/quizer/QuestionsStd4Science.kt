...
import kotlinx.android.synthetic.main.activity_questionsstd4science.*


class QuestionsStd4Science : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd4science)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd4Science> = getQuestionsStd4Science()
