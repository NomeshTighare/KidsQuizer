...
import kotlinx.android.synthetic.main.activity_questionsstd1gkn.*


class QuestionsStd1Gkn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd1gkn)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd1Gkn> = getQuestionsStd1Gkn()
