...
import kotlinx.android.synthetic.main.activity_questionsstd5english.*


class QuestionsStd5English : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd5english)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd5English> = getQuestionsStd5English()
