...
import kotlinx.android.synthetic.main.activity_questionsstd2gkn.*


class QuestionsStd2Gkn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd2gkn)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd2Gkn> = getQuestionsStd2Gkn()
