...
import kotlinx.android.synthetic.main.activity_questionsstd5math.*


class QuestionsStd5Math : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd5math)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd5Math> = getQuestionsStd5Math()
