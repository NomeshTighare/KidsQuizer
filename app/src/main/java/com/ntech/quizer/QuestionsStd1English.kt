...
import kotlinx.android.synthetic.main.activity_questionsstd1english.*


class QuestionsStd1English : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd1english)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd1English> = getQuestionsStd1English()
