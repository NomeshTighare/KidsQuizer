...
import kotlinx.android.synthetic.main.activity_questionsstd2evn.*


class QuestionsStd2Evn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd2evn)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd2Evn> = getQuestionsStd2Evn()
