...
import kotlinx.android.synthetic.main.activity_questionsstd3math.*


class QuestionsStd3Math : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd3math)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd3Math> = getQuestionsStd3Math()
