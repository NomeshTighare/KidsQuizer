...
class Std5_Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv1.setOnClickListener {
            val intent = Intent(this, QuestionsStd5English::class.java)
            startActivity(intent)
            finish()
        }
        tv2.setOnClickListener {
            val intent = Intent(this, QuestionsStd5Math::class.java)
            startActivity(intent)
            finish()
        }

        tv3.setOnClickListener {
            val intent = Intent(this, QuestionsStd5Marathi::class.java)
            startActivity(intent)
            finish()
        }
        tv4.setOnClickListener {
            val intent = Intent(this, QuestionsStd5History::class.java)
            startActivity(intent)
            finish()
        }
    }
