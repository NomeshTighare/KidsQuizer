...
import kotlinx.android.synthetic.main.activity_questionsstd2math.*


class QuestionsStd2Math : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd2math)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd2Math> = getQuestionsStd2Math()
