...
import kotlinx.android.synthetic.main.activity_questionsstd5history.*


class QuestionsStd5History : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd5history)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd5History> = getQuestionsStd5History()
