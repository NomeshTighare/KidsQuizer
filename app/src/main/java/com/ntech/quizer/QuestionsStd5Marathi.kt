...
import kotlinx.android.synthetic.main.activity_questionsstd5marathi.*


class QuestionsStd5Marathi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd5marathi)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd5Marathi> = getQuestionsStd5Marathi()
