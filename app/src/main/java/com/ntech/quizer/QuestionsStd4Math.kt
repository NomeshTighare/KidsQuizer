...
import kotlinx.android.synthetic.main.activity_questionsstd4math.*


class QuestionsStd4Math : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd4math)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd4Math> = getQuestionsStd4Math()
