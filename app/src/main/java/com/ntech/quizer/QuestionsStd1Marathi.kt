...
import kotlinx.android.synthetic.main.activity_questionsstd1marathi.*


class QuestionsStd1Marathi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd1marathi)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd1Marathi> = getQuestionsStd1Marathi()
