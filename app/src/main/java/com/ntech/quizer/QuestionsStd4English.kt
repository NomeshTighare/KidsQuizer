...
import kotlinx.android.synthetic.main.activity_questionsstd4english.*


class QuestionsStd4English : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd4english)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd4English> = getQuestionsStd4English()
