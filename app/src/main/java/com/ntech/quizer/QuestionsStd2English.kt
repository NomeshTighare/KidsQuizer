...
import kotlinx.android.synthetic.main.activity_questionsstd2english.*


class QuestionsStd2English : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_questionsstd2english)

        val allOptions = arrayListOf(tvOption1, tvOption2, tvOption3, tvOption4)
        val questions: ArrayList<QuestionStd2English> = getQuestionsStd2English()
